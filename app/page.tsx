  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{
        ...
        .animate-in { opacity: 0; animation: fadeInUp 0.8s ease-out forwards; }
        ...
        .vignette { position: absolute; inset: 0; background: radial-gradient(circle, transparent 30%, #000 100%); z-index: 1; }
      `}} />

      <div className="bg-container"><div className="vignette" /></div>

      <div style={{
        minHeight: '100dvh', color: '#ffffff',
        fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
        display: 'flex', justifyContent: 'center', alignItems: 'flex-start',
        position: 'relative', zIndex: 10, padding: '20px'
      }}>
        <main style={{ width: '100%', maxWidth: '450px', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '20px', paddingBottom: '40px' }}>

          <div className="animate-in" style={{
            width: '80%', marginBottom: '35px', padding: '10px',
            border: '1px solid rgba(217,119,6,0.4)', borderRadius: '24px',
            background: 'rgba(20,20,20,0.6)', backdropFilter: 'blur(15px)', WebkitBackdropFilter: 'blur(15px)',
          ...
          <div className="animate-in" style={{ marginBottom: '40px', textAlign: 'center', animationDelay: '0.3s' }}>
            ...
            <h1 className="neon-glow" style={{ fontSize: '52px', fontWeight: '900', margin: '0', background: 'linear-gradient(to bottom, #fff, #f59e0b, #d97706)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontStyle: 'italic', lineHeight: '0.9', textTransform: 'uppercase' }}>GRAND<br />OPENING</h1>
            <div style={{ height: '2px', width: '60px', background: '#d97706', margin: '15px auto 0' }} />
          </div>

          <div className="animate-in" style={{ display: 'flex', alignItems: 'stretch', gap: '12px', width: '100%', marginBottom: '40px', animationDelay: '0.6s' }}>
            <div style={{
              flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start',
              border: '1px solid rgba(255,255,255,0.08)', padding: '25px 10px', borderRadius: '20px',
              background: 'rgba(30,30,30,0.5)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)',
            ...
            <div style={{
              flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start',
              border: '2px solid rgba(245,158,11,0.6)', padding: '25px 10px', borderRadius: '20px',
          ...
          <div className="animate-in" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '15px', animationDelay: '0.9s' }}>
            <a href="https://www.google.com/maps/search/?api=1&query=MJ7H%2B89P+Banjarmasin" target="_blank" rel="noopener noreferrer" style={{ background: 'linear-gradient(180deg, #f59e0b, #d97706)', color: '#000', padding: '18px', borderRadius: '18px', fontWeight: '900', textDecoration: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', boxShadow: '0 8px 20px rgba(217,119,6,0.4)' }}>
              LOKASI GOOGLE MAPS
            </a>
            <a href="https://wa.me/628134236463?text=Halo%20Stars%20Billiard,%20saya%20ingin%20reservasi%20meja." target="_blank" rel="noopener noreferrer" style={{ border: '2px solid rgba(217,119,6,0.6)', color: '#fbbf24', padding: '18px', borderRadius: '18px', fontWeight: '900', textDecoration: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', background: 'rgba(217,119,6,0.08)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
              RESERVASI WHATSAPP
            </a>
          </div>
